    ...
    if (req.files && req.files.profile_image) {
      try {
        ...
        if (profileImageUrl) {
          ...
          console.warn('⚠️ Profile image upload returned null, keeping existing image');
        }
      } catch (error) {
        console.error('⚠️ Profile image upload failed, keeping existing image:', error.message);
      }
    }
    ...
    if (req.files && req.files.gym_logo) {
      try {
        ...
        if (gymLogoUrl) {
          ...
          console.warn('⚠️ Gym logo upload returned null, keeping existing logo');
        }
      } catch (error) {
        console.error('⚠️ Gym logo upload failed, keeping existing logo:', error.message);
      }
    }
