...
router.post('/register', verifyAdminToken, registerGymOwner);
router.get('/get/all', verifyAdminToken, getAllGymOwners);
router.get('/get-by/:id', verifyAdminToken, getGymOwnerById);
router.put('/update/:id', verifyAdminToken, updateGymOwnerById);
...
router.put('/update', verifyGymOwnerToken, updateGymOwner);
